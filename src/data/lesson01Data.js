...
export const lesson01Data = {
  ...
  pages: [
    ...
    },
    {
      ...
      badgeText: 'تحليل أصحاب المصلحة وصياغة القرار',
      unitTitle: 'الوحدة الأولى: أساسيات الحوسبة والذكاء الاصطناعي',
      lessonTitle: 'الدرس 1-1: تطور تكنولوجيا المعلومات والتحول الاجتماعي',
      content: {
        badge: 'الهدف التقييمي الثالث • تحليل أصحاب المصلحة وصياغة قرار مبرر بالأدلة',
        title: 'جلسة المحكمة التقنية: هل التحول إلى الدفع الرقمي الكامل عادل للجميع؟',
        scenario:
          'قرية مصرية نائية اتصلت بشبكة الإنترنت لأول مرة هذا الشهر. تدرس المحافظة تحويل كافة مدفوعات الخدمات العامة (فواتير الكهرباء، مياه الشرب، رسوم المدارس ومكتب البريد) إلى نظام رقمي إلكتروني كامل خلال عام واحد ومنع التعامل النقدي الورقي نهائياً. بصفتك مستشاراً تقنياً في لجنة القرار، يطلب منك تقييم أثر القرار على فئات المجتمع وصياغة توصية مبررة بالأدلة.',
        stakeholders: [
          {
            role: 'الفئة (أ): الشاب التقني وموظف العمل عن بُعد',
            interest: 'توفير فائق للوقت، التخلص من طوابير مكاتب البريد، وسداد كافة الالتزامات بضغطة زر لحظياً.',
            consideration: 'المكسب: راحة كاملة، أمان مالي، وسرعة تسوية فورية عبر تطبيقات الدفع الذكية (InstaPay / المحافظ).',
          },
          {
            role: 'الفئة (ب): صاحب الدكان الصغير أو التاجر المحلي',
            interest: 'يحتاج لسيولة نقدية يومية لشراء البضائع، ويخشى اقتطاع عمولات بنكية أو توقف شبكة الاتصالات.',
            consideration: 'التحدي: تكلفة ماكينات الدفع الإلكتروني (POS)، عمولات العمليات، والحاجة للتدريب على تسوية الحسابات.',
          },
          {
            role: 'الفئة (ج): كبار السن ومحدودو الدخل (بلا هاتف ذكي أو حساب بنكي)',
            interest: 'الاعتماد الكامل على النقد الورقي، وصعوبة القراءة الرقمية أو التعامل مع التطبيقات البنكية.',
            consideration: 'الخطر الجسيم: الإقصاء الاجتماعي، العجز عن سداد الخدمات الأساسية، والاضطرار للجوء لوسطاء بمقابل إضافي.',
          },
        ],
        prompts: [
          {
            question:
              'استناداً إلى تحليل أصحاب المصلحة، ما الفئة الأكثر تضرراً من تطبيق هذا النظام بصفة فورية وحصرية؟ وما سبب ذلك؟',
          },
          {
            question:
              'بصفتك مستشار لجنة القرار، ما هو قرارك المبرر بالأدلة؟ واذكر شرطاً إلزامياً حاسماً يجب تحقيقه لحماية الفئات المستبعدة قبل بدء التطبيق.',
          },
        ],
        reflection: {
          title: 'قاعدة المُرشد الهندسية لصناع القرار',
          text:
            '«التقنية ليست محايدة؛ نجاح أي منظومة رقمية لا يُقاس بمدى رفاهية وسعادة من يمتلكون أحدث الهواتف الذكية، بل بمدى حمايتها وعدم إقصائها للفئات الأضعف في المجتمع. مهندس المستقبل يصنع حلولاً تحتضن الجميع ولا تترك أحداً خلف الركب.»',
        },
      },
    },
    {
      ...
      pageNumber: '08',
      type: 'REVISION',
      badgeText: 'المراجعة والتثبيت والتحدي الختامي',
      unitTitle: 'الوحدة الأولى: أساسيات الحوسبة والذكاء الاصطناعي',
      lessonTitle: 'الدرس 1-1: تطور تكنولوجيا المعلومات والتحول الاجتماعي',
      content: {
        badge: 'المحطة الختامية • تثبيت المكتسبات المعرفية للمنهج',
        title: 'خلاصة الدرس 1-1: ركائز تطور تكنولوجيا المعلومات والتحول الاجتماعي',
        summaryCards: [
          {
            title: '١. المنطق السببي الحتمي',
            content:
              'كل جهاز وتقنية عتادية جديدة أتاحت قدرة بشرية غير مسبوقة، وهذه القدرة ولّدت تحولاً جذرياً في سلوك ونمط حياة المجتمع.',
          },
          {
            title: '٢. شجرة البنية المشتركة',
            content:
              'التحولات الخمسة (التواصل، التجارة، العمل، التعلم، الدفع) ليست جزرًا منعزلة، بل ثمرات تتغذى على ثلاثية: هاتف + إنترنت + سحابة.',
          },
          {
            title: '٣. الحوسبة الطرفية والضرورة الأمنية',
            content:
              'ليست كل البيانات مؤهلة لتسافر إلى السحابة؛ الأنظمة الحرجة كمركبات القيادة الذاتية تفرض حوسبة طرفية محلية لمنع حوادث الاصطدام.',
          },
        ],
        keyTerms: [
          { term: 'قانون مور (Moore\'s Law)', definition: 'ملاحظة تجريبية تنص على تضاعف ترانزستورات الرقاقة كل عامين تقريباً مع انخفاض التكلفة، وقد بدأ يتباطأ.' },
          { term: 'شبكات التواصل (SNS)', definition: 'منصات رقمية تنقل المستخدم من متلقٍ سلبي إلى صانع محتوى وناشر ومشارك في مجتمعات افتراضية.' },
          { term: 'التجارة الإلكترونية (E-Commerce)', definition: 'شراء وبيع السلع والخدمات عبر الشبكات دون التقيد بالحدود الجغرافية على مدار الساعة.' },
          { term: 'العمل والتعلم عن بُعد', definition: 'فصل الإنتاجية الوظيفية واكتساب المعرفة الأكاديمية عن الحضور المكاني الفعلي عبر المنصات الرقمية.' },
          { term: 'الدفع غير النقدي (Cashless)', definition: 'تسوية المعاملات المالية إلكترونياً عبر المحافظ والبطاقات ورموز QR دون تداول الأوراق النقدية.' },
          { term: 'الحوسبة الطرفية (Edge Computing)', definition: 'معالجة البيانات محلياً داخل الجهاز أو بجواره لتقليص زمن الاستجابة (Latency) لأجزاء من الألف من الثانية.' },
          { term: 'الواقع المعزز (AR) مقابل الافتراضي (VR)', definition: 'الواقع المعزز يُضيف طبقة رقمية فوق العالم الحقيقي، بينما الواقع الافتراضي يستبدل العالم الحقيقي بانغماس كامل.' },
          { term: 'الحوسبة الكمومية (Quantum)', definition: 'توظيف الكيوبت (Qubit) وخاصية التراكب لحل مسائل رياضية وتشفيرية معقدة تفوق قدرة الحواسيب الكلاسيكية.' },
        ],
        checkQuestions: [
          'هل قانون مور قانون فيزيائي ثابت كقانون الجاذبية؟ فسر إجابتك علمياً.',
          'ما الفارق التقني الحاسم بين فلتر كاميرا الهاتف ولعبة الخوذة الانغماسية الميدانية؟',
          'لماذا لا تستطيع سيارة ذاتية القيادة بسرعة 120 كم/س الانتظار لاستقبال أمر الفرامل من السحابة؟',
          'لماذا تقتضي العدالة الاجتماعية عدم إلغاء النقد الورقي فوراً عند إطلاق منظومة الدفع الرقمي؟',
        ],
        mentorClosing: {
          title: 'رسالة المُرشد وتمهيد الدرس القادم',
          text:
            '«تهانينا يا مهندس المستقبل! لقد أدركت اليوم كيف تصنع تكنولوجيا المعلومات مجتمعاتنا وكيف نقيّم أثرها. استعد في الدرس القادم (الدرس 1-2: كيف يعمل الذكاء الاصطناعي) لنغوص في عقل الآلة ونتعلم كيف تفكر وتتعلم من البيانات!»',
        },
      },
    },
  ],
